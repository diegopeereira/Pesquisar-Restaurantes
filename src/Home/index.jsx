...
import MaterialIcon from '@material/react-material-icon'; // Importação do pacote de ícones de materiais 
...
<Container>
  <Search>
    ...
    <TextField label="Pesquisar Restaurantes"
        outlined trailingIcon={<MaterialIcon role="button" icon="search"/>}>
